...
const Workflow = () => {
    return (
        <div className='bg-linear-to-r from-blue-900 to-purple-500 text-white py-10 md:py-30 px:20 md:px-50 flex flex-col justify-center items-center text-center'>
            <div className='mb-10'>
