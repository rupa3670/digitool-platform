        ...
        <footer className=" bg-[#101727] text-white   p-10">
            <div className='footer sm:footer-horizontal'>
                ...
                <nav className='text-gray-500'>
                    <h6 className="text-[20px] text-white">Product</h6>
                ...
                <nav className='text-gray-500'>
                    <h6 className="text-[20px] text-white">Company</h6>
                    <a className="">About </a>
                ...
                <nav className='text-gray-500'>
                    <h6 className="text-[20px] text-white">Resources</h6>
            ...
            <div className='border-t border-gray-800 pt-8 mt-10'>
                <div className='flex flex-col md:flex-row justify-between items-center gap-4'>
                    <p className='text-gray-500'>copyrights 2026 DigiTools. All rights reserved.</p>
